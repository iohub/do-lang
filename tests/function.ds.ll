...
if-else:                                          ; preds = %entry
  %2 = sub i64* %n, i64 1
  %3 = call i64 @"fact\EB\7F"(i64* %2)
  %4 = mul i64 %3, i64* %n
  ret i64 %4
}

define i64 @"main\EB\7F"() {
entry:
  %a = alloca i64
  store i64* %a, i64 1093
  %b = alloca i64
  %0 = call i64 @"foo1\EB\7F"(i64* %a, i64 100)
  %1 = add i64 %0, 123
  %2 = call i64 @"foo1\EB\7F"(i64* %a, i64 12)
  %3 = add i64 %1, %2
  store i64* %a, i64 %3
  %4 = add i64* %a, i64 120
  %5 = call i64 @"foo1\EB\7F"(i64 123, i64* %4)
  store i64* %b, i64 %5
}
